    ...
    namespace
    {
        ...
        public:
            server_ctx(TObs&& observer, const server_config& config)
                ...
                , m_acceptor{m_ioc, boost::asio::ip::tcp::endpoint{boost::asio::ip::make_address(config.ip), config.port}}
                , m_config{config}
            {
            }
        ...
        private:
            ...
            [[no_unique_address]] TObs     m_observer;
